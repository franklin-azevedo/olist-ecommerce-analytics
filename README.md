...
Here are a few visual samples generated by the analytics layer to support executive decision-making:

* **Revenue Distribution & Top Categories:**
  ![Revenue by Category](output/charts/revenue_by_category.png)

* **Temporal Sales Trends:**
  ![Sales Over Time](output/charts/sales_over_time.png)

*(Note: Ensure your generated charts inside `output/charts/` match these filenames, or adjust the filenames above if yours have slightly different names).*
